...
### 音频管线
- **Hi-Res PCM24 直通** — 24-bit 96kHz 原生采样率传输（Protocol v3），仅限局域网
...
### Android 客户端
- **编码器选择** — UI 上可选 Auto / Opus / PCM 16 / PCM 24
- **延迟图表** — 实时对比优化前 vs 当前延迟
...
| [Hi-Res PCM24](docs/hires_pcm24.md) | PCM24 直通设计文档 |
